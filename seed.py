...
def seed_users():
    users = [
        ...
        User(username="asd", password_hash="pbkdf2:sha256:600000$FwCwXGy0AtpX7ynx$49f105246ad1c31fea49a5577da11b1937f5643514ca367507621e7518cc3c3d", is_admin=0, balance=0)
    ]
    for user in users:
        db.session.add(user)
    db.session.commit()
